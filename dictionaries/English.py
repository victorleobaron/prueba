...
class English(Languaje):
    ...
    def get_grammar(self):
        ...
        self.grammar = """
            ...
            | continuous_present                -> presente_contiuo
            | article                           -> articulo
            | literal_verb                      -> verbo
            ...
            /// PRESENTE CONTINUO
                continuous_present: pro_f to_be_f gerund_verb
                                |   pro_s to_be_s gerund_verb
                                |   pro_third to_be_t gerund_verb
                                |   pro_plural to_be_plural gerund_verb
            //
